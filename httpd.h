...
#define LIBRARY_QUERY       "httpd_library_query"
#define LIBRARY_CLEANUP     "httpd_library_cleanup"
#define httpd_NAME        "httpd v0.2"
...
typedef struct _socket_data {
    ...
    httpd* set;       // pointer to global setting.
} socket_data;
...
extern const char *httpd_mime_map(const char *ext);
extern const char *httpd_gmtime();
